...
public class LoanBean implements Serializable {
	...
	public String addLoanRequest() throws ParseException {
		...
		l.setId(1);
		product = l;
		Date h = new SimpleDateFormat("yyyy-MM-dd").parse("2019-05-11");
		loanservice.addLoan(new Loan(client, product, sqlStartDate, sqlStartDate1,h, amount, name, State.INPRGRESS));
